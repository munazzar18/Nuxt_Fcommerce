        ...
        <div class="flex justify-center">
            <div class=" mx-2 bg-[#5bccf6] p-6 rounded-box">
                <div v-if="orderItems.length === 0">
                    ...
                    <div class="">
                        <img src="/emptyCart.png" alt="Empty cart!" class="h-48 w-full aspect-[3/2] object-contain" />
                    </div>
                </div>
                <div v-else>
                        ...
                        <div class=" overflow-x-auto font-bold">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="item in orderItems" :key="item.id">
                                        <td><input type="checkbox" @change="toggleCheck(item.id)"
                                                :checked="isChecked[item.id]" @click="selectedItems(item.id, item.quantity)"
                                                class="checkbox" /></td>
                                        ...
                                        <td class="text-center">
                                            <div class="flex items-center">
                                                ...
                                                <input type="text" class="w-12 text-center border rounded-md px-2 py-1"
                                                    min="1" v-model="item.quantity" readonly />
                            ...
                            <div class="flex justify-end mt-24 px-4">
                                <button @click="checkOut" :disabled="!isAnyChecked"
                                    class="btn bg-[#030e12] border-0 hover:bg-[#fcde67] hover:text-[#030e12] text-[#5bccf6]">Proceed
                                    To Checkout</button>
                            </div>
                        </div>
                    </div>
